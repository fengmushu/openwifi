...
HDF_FILE=$OPENWIFI_HW_DIR/boards/$BOARD_NAME/sdk/system_top.xsa
BIT_FILE=$OPENWIFI_HW_DIR/boards/$BOARD_NAME/sdk/system_top.bit
...
echo $HDF_FILE | grep -q ".xsa" || usage
...
cp $BIT_FILE $BUILD_DIR/build/sdk/hw_0/
